...
#' @param ... optional arguments passed to \code{\link{rftResults}}
#' @return returns object of class rftContrast
#' @details Creates F-statistic images based upon the provided contrastMatrix.
#'
#'
...
anova.rftModel <- function(rftModel, contrastMatrix, cthresh = 150,
                           isotropic = NULL, ...) {
